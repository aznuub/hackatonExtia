...
function Homepage(props) {
  ...
  const [city, setCity] = useState(
    cityData.find((cityItem) => cityItem.name === "Paris")
  );
  const [destination, setDestination] = useState(
    cityData.find((cityItem) => cityItem.name === "Barcelone")
  );
      ...
      <div id="part2" style={mainBox(blue, 800)}>
        <div id="sidePanelLeft" style={part2panelLeft}>
          <div id="triplePack" style={triplePack}>
            <div id="pack" style={triplePackElem}>
              TripleOne
            </div>
            <div id="pack" style={triplePackElem}>
              TripleTwo
          ...
          <div id="doubleColListMain" style={doubleColListMain}>
            <div id="doubleColTitle" style={doubleColListTitle}>
              Nothing to see here
            </div>
            <div id="doubleColList" style={doubleColList}>
              <div id="doubleColListElem" style={doubleColListElem}>
                <img
                  id="doubleColListElemIcon1"
                  style={doubleColListElemIcon}
                  src="https://github.com/aznuub/hackatonExtia/blob/main/src/images/city/aix.png?raw=true"
                />
                <div id="doubleColListElemText1" style={doubleColListElemText}>
                  Aix en provence
                </div>
              </div>
              <div id="doubleColListElem" style={doubleColListElem}>
                <img
                  id="doubleColListElemIcon1"
                  style={doubleColListElemIcon}
                  src="https://github.com/aznuub/hackatonExtia/blob/main/src/images/city/barcelone.png?raw=true"
                />
                <div id="doubleColListElemText1" style={doubleColListElemText}>
                  Barcelone
                </div>
              ...
              <div id="doubleColListElem" style={doubleColListElem}>
                <img
                  id="doubleColListElemIcon1"
                  style={doubleColListElemIcon}
                  src="https://github.com/aznuub/hackatonExtia/blob/main/src/images/city/bordeaux.png?raw=true"
                />
                <div id="doubleColListElemText1" style={doubleColListElemText}>
                  Bordeaux
                </div>
              ...
              <div id="doubleColListElem" style={doubleColListElem}>
                <img
                  id="doubleColListElemIcon1"
                  style={doubleColListElemIcon}
                  src="https://github.com/aznuub/hackatonExtia/blob/main/src/images/city/bruxelle.png?raw=true"
                />
                <div id="doubleColListElemText1" style={doubleColListElemText}>
                  Bruxelles
                </div>
        ...
        <div id="sidePanelRight" style={part2panelRight}>
          <img
            style={{ width: "100%" }}
            src="https://c.tenor.com/ve60xH3hKrcAAAAC/no.gif"
            alt="nope"
          />
        </div>
      </div>
      <div id="part3" style={mainBox(green, 800)}>
        <div id="part3PanelLeft" style={part3PanelLeft}>
          <div id="part3PanelLeftLogo" style={part3PanelLeftLogo}>
            <img
              style={part3PanelLeftLogoImage}
              src="https://phantom-marca.unidadeditorial.es/a12ae8bfd4cbe2bbec80cc9c70ea6301/resize/1320/f/jpg/assets/multimedia/imagenes/2022/05/26/16535796722201.jpg"
            ></img>
          </div>
          <div id="part3PanelLeftTubes" style={part3PanelLeftTubes}>
            <div id="part3PanelLeftTubeElem1" style={part3PanelLeftTubeElem}>
              {" "}
              Hello there
            </div>
            <div id="part3PanelLeftTubeElem2" style={part3PanelLeftTubeElem}>
              {" "}
              General Kenobi
            </div>
            <div id="part3PanelLeftTubeElem3" style={part3PanelLeftTubeElem}>
              {" "}
              You are a bold one
            </div>
            <div id="part3PanelLeftTubeElem4" style={part3PanelLeftTubeElem}>
              {" "}
              Not a prequel Quote
            </div>
            <div id="part3PanelLeftTubeElem3" style={part3PanelLeftTubeElem}>
